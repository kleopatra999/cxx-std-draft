...
Allocator& a = Allocator())} and \tcode{basic_string& operator=(Range&& range)}
shall additionally not participate if \tcode{typename remove_cv<typename
remove_reference<Range>::type>::type} is \tcode{basic_string} or a type derived
from \tcode{basic_string}.
